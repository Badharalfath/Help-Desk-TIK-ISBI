...
@section('content')
    ...
    <div class="container mx-auto py-10">
        ...
        <!-- Filter Form -->
        <div class="mb-6">
            <form method="GET" action="{{ route('tiket') }}">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="kategori" id="kategori"
                            ...
                            <option value="Email/Website" {{ request('kategori') == 'Email/Website' ? 'selected' : '' }}>
                    ...
                    <div>
                        <label for="progress_status" class="block text-sm font-medium text-gray-700">Progress Status</label>
                        <select name="progress_status" id="progress_status"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm">
                            <option value="">Semua Status</option>
                            <option value="solved" {{ request('progress_status') == 'solved' ? 'selected' : '' }}>Solved
                            </option>
