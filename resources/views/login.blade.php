            ...
            <form class="space-y-4 md:space-y-6" action="#" method="POST">
                @csrf
                  ...
                  <div class="flex items-center justify-between">
                      ...
                      <a href="{{ route('home') }}" class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Forgot password?</a>
                  </div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Don’t have an account yet? <a href="{{ route('dashboard') }}" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>
                  </p>
              </form>
          </div>
      </div>
