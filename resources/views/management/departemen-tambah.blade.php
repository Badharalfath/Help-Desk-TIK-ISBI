...
<div class="bg-gray-100 rounded-lg shadow-md max-w-lg mx-auto p-4 px-8 mt-10">
    ...
    <form method="POST" action="{{ route('departemen.store') }}" class="max-w-lg mx-auto p-4">
        ...
        <div class="mb-4">
            <label for="kd_departemen" class="block text-sm font-medium text-gray-700">Kode Departemen</label>
            <input type="text" name="kd_departemen" id="kd_departemen" value="{{ $kodeOtomatis }}"
